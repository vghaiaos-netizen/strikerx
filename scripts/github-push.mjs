...
const ALLOW_ROOTS = new Set(["artifacts","lib","docs","scripts","package.json","pnpm-workspace.yaml","pnpm-lock.yaml","tsconfig.json","tsconfig.base.json","replit.md",".gitignore","railway.json","Dockerfile",".npmrc",".dockerignore"]);
